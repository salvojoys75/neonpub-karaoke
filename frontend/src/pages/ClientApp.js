        ...
        {activeTab === "home" && (
          <div className="space-y-6 animate-fade-in-up">
            ...
            <div className="flex gap-3">
              <Button onClick={() => setShowMessageModal(true)} variant="outline" className="flex-1 border-zinc-700 hover:bg-zinc-800"><MessageSquare className="w-4 h-4 mr-2" /> Messaggio</Button>
              <Button onClick={() => { setSelfiePreview(null); setSelfieSent(false); setShowSelfieModal(true); }} className="flex-1 bg-gradient-to-r from-pink-500 to-fuchsia-600 font-bold"><Camera className="w-4 h-4 mr-2" /> Selfie</Button>
            </div>
