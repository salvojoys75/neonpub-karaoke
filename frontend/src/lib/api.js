...
export const startPerformance = async (requestId, youtubeUrl) => {
  // Nota: Qui non usiamo getParticipantFromToken perché è l'admin a chiamarla
...
// *** MESSAGES: VERSIONE IBRIDA ADMIN/USER ***
export const sendMessage = async (data) => {
  ...
  try {
     ...
     // Fallback per Admin: recupera ID evento dal localStorage
     const pubCode = localStorage.getItem('neonpub_pub_code');
     if(pubCode) {
